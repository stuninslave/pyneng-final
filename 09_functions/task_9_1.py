...
def generate_access_config(intf_vlan_mapping, access_template):
	...
	'''
	config_file=[]
	for intf_name,intf_vlan in intf_vlan_mapping.items():
		config_file.append('interface '+ intf_name)
		for command in access_template:
			if command.endswith('access vlan'):
				config_file.append('{} {}'.format(command,intf_vlan_mapping[intf_name]))				
			else:
				config_file.append(('{}'.format(command)))				
	return config_file
